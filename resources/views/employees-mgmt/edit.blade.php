                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', ['id' => $employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('birthdate') ? ' has-error' : '' }}">
                            <label for="nationality" class="col-md-4 control-label">Date of Birth</label>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="children" class="col-md-4 control-label">Do you have children</label>

                            <div class="col-md-6">
                                <input id="children" type="text" class="form-control" name="children" value="@if($employee->children == 1) Yes @else No @endif" required>
                        ...
                        <div class="form-group{{ $errors->has('') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="availability" type="date" class="form-control" name="availability" value="{{ $employee->availability}}" required>
