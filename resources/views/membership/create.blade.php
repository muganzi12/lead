        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('membership.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <label for="committees" class="col-md-4 control-label">Numbers of commitees</label>
                               ...
                               <div class="col-md-6">
                               <input id="commitees" type="int" class="form-control" name="commitees" value="{{ old('commitees') }}" required>
