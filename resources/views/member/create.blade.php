    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">@if(Auth::check()) Add new Memberss @else Fill in Your Details @endif</div>
                <table class="table">
                    ...
                    {{ csrf_field() }}
                       ...
                       <td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="genda" type="text" class="form-control" name="genda" value="{{ old('genda') }}" required>
                        ...
                        <td>
                        <div class="form-group">
                            <label for="personal_circumstances" class="col-md-4 control-label">Marital Status</label>
                        ...
                        <td>
                        <div class="form-group">
                            <label for="personal_circumstances" class="col-md-4 control-label">Professional Cirmustances</label>

                            <div class="col-md-6">
                                <input id="personal_circumstances" type="text" class="form-control" name="personal_circumstances" value="{{ old('personal_circumstances') }}" required>
