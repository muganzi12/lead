        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('companies.update', ['id' => $companies->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" value="{{ $companies->address }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('tin_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tin_number" type="text" class="form-control" name="tin_number" value="{{ $companies->tin_number}}" required autofocus>
