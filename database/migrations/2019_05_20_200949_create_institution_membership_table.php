...
class CreateInstitutionMembershipTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('institution_membership', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('institution_membership');
    }
}
